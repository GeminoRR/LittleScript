...
Public Class lexer
    ...
    '========= GetTokensFromLine =========
    '=====================================
    Public Function parse(ByVal file As LSFile) As List(Of token)
        ...
        While Not currentChar = Nothing
            ...
            ElseIf currentChar = "&" Then
                ...
                tokens.Add(New token(tokenType.OP_CONCAT, charCounter, charCounter))
                advance()
            ...
            ElseIf currentChar = "/" Then
                ...
                If charCounter + 1 < text.Length Then
                    If text(charCounter + 1) = "/" Then
                        advance(2)
                        While Not (currentChar = vbCr Or currentChar = Environment.NewLine Or charCounter >= text.Length)
                            advance()
                        End While
                        Continue While
                    End If
            ...
            ElseIf authorizedNameCharacters.Contains(currentChar) Then
                ...
                Select Case create_var.ToLower()
                    ...
                    Case "set"
                        tokens.Add(New token(tokenType.KW_SET, startPos, charCounter - 1))
                    Case "to"
                    ...
                    Case "do"
                        tokens.Add(New token(tokenType.KW_DO, startPos, charCounter - 1))
                    Case "append"
                        tokens.Add(New token(tokenType.KW_APPEND, startPos, charCounter - 1))
                    Case "import"
                    ...
                    Case "not"
                        tokens.Add(New token(tokenType.OP_NOT, startPos, charCounter - 1))
                    Case "in"
