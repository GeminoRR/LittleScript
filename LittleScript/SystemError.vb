Module SystemError
    ...
    '========== COMPLEX ERROR ==========
    '===================================
    Public Sub addComplexError(ByVal code As String, ByVal title As String, ByVal message As String, ByVal file As LSFile, ByVal positionStart As Integer, ByVal positionEnd As Integer, Optional ByVal trymessage As String = "")
    ...
    '========== SYNTAX ERROR ==========
    '==================================
    Public Sub addSyntaxError(ByVal code As String, ByVal message As String, ByVal file As LSFile, ByVal positionStart As Integer, ByVal positionEnd As Integer, Optional ByVal trymessage As String = "")
    ...
    '========== NAMING ERROR ==========
    '==================================
    Public Sub addNamingError(ByVal code As String, ByVal message As String, ByVal file As LSFile, ByVal positionStart As Integer, ByVal positionEnd As Integer, Optional ByVal trymessage As String = "")
    ...
    '========== TYPE ERROR ==========
    '================================
    Public Sub addTypeError(ByVal code As String, ByVal message As String, ByVal file As LSFile, ByVal positionStart As Integer, ByVal positionEnd As Integer, Optional ByVal trymessage As String = "")
